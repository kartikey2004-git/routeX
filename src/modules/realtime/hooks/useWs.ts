...
type WsMessage = {
  ...
  // what type of messge : message bheja hai ya recieved kra hai --> full duplex connection hota hai

  // we can send events from server and client and managed from both side
...
// websockets options : integrate all the events as better level as possible
...
interface WsStore {
  ...
  // editor draft jaha pr editor mein koi data likh diya hai aur humne save nhi kra hai , toh usko persistenly connect kr skte hai
